...
<head>
    <meta charset="utf-8">
    <title>Salmonella Free Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">SALMONELLA FREE CERTIFICATE</th>
    </tr>
    <tr>
...
{{-- ══════════════════════════════════════════════════════════════
     SECTION 3: CONSIGNEE / BENEFICIARY
     ══════════════════════════════════════════════════════════════ --}}
<table cellspacing="0" cellpadding="3">
    <tr>
    ...
    <tr>
        ...
        <th width="50%" align="left">BENEFICIARY:</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td align="left">KGS OF {{ trim($h->marca ?? '') }} BRAND {{ $sif }}, {{ $paisInt }} ORIGIN</td>
    </tr>
    ...
    @if(trim($h->texto_bl1 ?? ''))
        <tr>
            <th align="left"></th>
            <td align="left">{{ trim($h->texto_bl1) }}</td>
        </tr>
    @endif
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            "IT IS HEREBY CERTIFIED THAT THE GOODS DESCRIBED ABOVE HAVE BEEN ANALYSED BY PRIVATE LABORATORY AND WERE FOUND TO BE PROPER FOR HUMAN CONSUMPTION. THESE GOODS ARE FREE FROM ANY SALMONELLA AND CONFIRMED ACCORDINGLY WITH THEIR SPECIFICATION BY FEDERAL INSPECTION SERVICE Nº <b>{{ $sif }}</b>"
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
