...
<head>
    <meta charset="utf-8">
    <title>MBM Free Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">MBM FREE CERTIFICATE</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            WE HEREBY CERTIFY THAT THE ABOVE MENTIONED PRODUCTS EXPORTED BY <b>{{ $empresa }} - {{ $sif }} WERE NOT</b> FEED ON ANY CRUSHED MEAT OR BONE FODDER BASED ON <b>MEAT AND BONE MEAL (MBM)</b>.
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
