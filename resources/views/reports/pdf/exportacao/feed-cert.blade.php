...
<head>
    <meta charset="utf-8">
    <title>Feed Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">FEED CERTIFICATE</th>
    </tr>
    <tr>
...
{{-- ══════════════════════════════════════════════════════════════
     SECTION 3: CONSIGNEE / EXPORTER (sem "TO WHOM IT MAY CONCERN")
     ══════════════════════════════════════════════════════════════ --}}
<table cellspacing="0" cellpadding="3">
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            "THIS CERTIFICATE ATTEST THAT ALL FEED IN {{ $empresa }} CHICKEN PRODUCTS ARE WITHIN APPROVED TOLERANCES OF MINISTRY OF AGRICULTURE OF BRAZIL."
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
