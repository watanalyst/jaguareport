...
<head>
    <meta charset="utf-8">
    <title>Dioxin Free Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">DIOXIN FREE CERTIFICATE</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            WE HEREBY CERTIFY THAT THE CHICKENS EXPORTED BY COMPANY {{ $empresa }} - {{ $endereco }} {{ $municipio }} - {{ $uf }} - {{ $paisEmp }}, ARE DERIVED FROM BIRDS BORN AND REARED IN BRAZIL. WE ALSO ARE STATING THA THE PRODUCTS ARE FREE FROM DIOXIN.
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
