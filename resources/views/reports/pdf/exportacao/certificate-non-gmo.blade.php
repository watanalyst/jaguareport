...
<head>
    <meta charset="utf-8">
    <title>Certificate of Non-Gmo {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">CERTIFICATE OF NON-GMO</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            WE <b>{{ $empresa }}</b> HEREBY DECLARE THAT THE PRODUCT ABOVE MENTIONED IS <b>FREE</b> OF ANY "GENETICALLY MODIFIED SUBSTANCE" AND IS IN COMPLIANCE WITH "NON GENETICALLY MODIFIED" SUBSTANCE LABELLING.
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
