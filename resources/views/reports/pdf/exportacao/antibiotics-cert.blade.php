...
<head>
    <meta charset="utf-8">
    <title>Antibiotics Free Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">ANTIBIOTICS FREE CERTIFICATE</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="60%" align="center">
            "WE HEREBY CERTIFY THAT THE ABOVE MENTIONED PRODUCTS EXPORTED BY
            <b>{{ $empresa }} - {{ $sif }}</b> DO NOT CONTAIN ANY RESIDUES OF THE
            FOLLOWING ANTIBIOTICS: <b>NITROFURANS, CHLORAMPHENICOL, VIRGINAMYCIN,
            SPIRAMYCIN, ZINC BACTRACIN</b> AND <b>TYLOSIN PHOSPHATE</b>."
        </td>
        <td width="20%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
