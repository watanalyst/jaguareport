...
<head>
    <meta charset="utf-8">
    <title>Certificate Radioactivity {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">CERTIFICATE OF NON RADIOACTIVITY</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            "WE HERBY CERTIFY THAT GOODS DESCRIBED IN THIS CERTIFICATE ARE FREE FROM HARMFUL RADIATION AND ARE WITHIN INTERNATIONALLY PERMISSIBLE LIMITS AND FIT FOR HUMAN CONSUPTION".
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
