...
<head>
    <meta charset="utf-8">
    <title>Newcastle Disease Free Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">NEWCASTLE DISEASE FREE CERTIFICATE</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="70%" align="center">
            WE HEREBY CERTIFY THAT THE ABOVE MENTIONED PRODUCTS EXPORTED BY </br><b>{{ $empresa }} - {{ $sif }}:</b>
        </td>
        <td width="15%"></td>
    </tr>
    <tr><td style="height: 5px;"></td></tr>
    <tr>
        <td width="15%"></td>
        <td colspan="2"><b>1 -</b> ARE ORIGINATED FROM ANIMALS THAT DID NOT COME FROM AREAS WHICH HAVE NEWCASTLE DISEASE;</td>
    </tr>
    <tr>
        <td width="15%"></td>
        <td colspan="2"><b>2 -</b> WERE SLAUGHTERED IN AREA FREE OF NEWCASTLE DISEASE;</td>
    </tr>
    <tr>
        <td width="15%"></td>
        <td colspan="2"><b>3 -</b> WERE PRODUCED IN AREA FREE OF NEWCASTLE DISEASE;</td>
    </tr>
    <tr>
        <td width="15%"></td>
        <td colspan="2"><b>4 -</b> WERE PACKED IN AREA FREE OF NEWCASTLE DISEASE.</td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
</table>
