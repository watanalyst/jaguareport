...
<head>
    <meta charset="utf-8">
    <title>Hormon Free Certificate {{ trim($h->proforma) }}-{{ trim($h->embarque) }}</title>
    <style>
...
<table cellspacing="0" cellpadding="2">
    <tr>
        <th align="center" style="font-size: 16px; font-weight: bold;">HORMON FREE CERTIFICATE</th>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="50%" align="center">
            WE HEREBY CERTIFY THAT THE ABOVE MENTIONED EXPORTED PRODUCTS WERE NOT OBTAINED FROM ANIMALS TREATED WITH HORMONES OR SUBSTANCES OF HORMONAL EFFECT THAT CAN BE HARMFUL TO PUBLIC HEALTH.
        </td>
        <td width="25%"></td>
    </tr>
    <tr><td style="height: 10px;"></td></tr>
